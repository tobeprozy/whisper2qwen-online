...
python3 whisper_online.py demo.wav --min-chunk-size 1 --dev_id 0 > out.txt
```
...
# local connect
# mic (linux)
arecord -f S16_LE -c1 -r 16000 -t raw -D default | nc localhost 10086
...
# remote connect
ssh -fN -L 10086:127.0.0.1:10086 {user}@{host-ip}
# mic
