...
class Qwen:
    def __init__(self, args):
        ...
        # load tokenizer
        print("Load " + args.qtoken + " ...")
        self.sp = AutoTokenizer.from_pretrained(args.qtoken, trust_remote_code=True)
        ...
        self.net = sail.Engine(args.qbmodel, args.qdev_id, sail.IOMode.DEVIO)
        self.handle = sail.Handle(args.qdev_id)
    ...
    def chat(self,input_src):
        # Stop Chatting with "exit" input
        self.input_str = input_src
